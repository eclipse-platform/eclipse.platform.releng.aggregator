...
"""
  ...
  stages {
              ...
              container('jnlp') {
                  sshagent(['git.eclipse.org-bot-ssh']) {
                      dir ('eclipse.platform.releng.aggregator') {
                        sh '''
                            git clone -b R4_17_maintenance ssh://genie.releng@git.eclipse.org:29418/platform/eclipse.platform.releng.aggregator.git
                        '''
                      }
                    }
                    sh '''
	  ...
	  stage('Swt build input') {
	      steps {
	          build 'SWT-Increment_chromium-maintenance'
	      }
	    }
