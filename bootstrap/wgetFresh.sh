...
wget --no-verbose --no-cache  -O re-mb4I.sh http://git.eclipse.org/c/platform/eclipse.platform.releng.aggregator.git/plain/bootstrap/re-mb4I.sh?h=$initScriptTag 2>&1;
