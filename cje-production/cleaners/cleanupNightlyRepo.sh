...
eclipseIRepo="${remoteBase}/eclipse/updates/4.35-I-builds"
eclipseYRepo="${remoteBase}/eclipse/updates/4.35-Y-builds"
eclipsePRepo="${remoteBase}/eclipse/updates/4.35-P-builds"
