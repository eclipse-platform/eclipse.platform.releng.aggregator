...
eclipseIRepo="${remoteBase}/eclipse/updates/4.28-I-builds"
eclipseYRepo="${remoteBase}/eclipse/updates/4.27-Y-builds"
eclipsePRepo="${remoteBase}/eclipse/updates/4.27-P-builds"
