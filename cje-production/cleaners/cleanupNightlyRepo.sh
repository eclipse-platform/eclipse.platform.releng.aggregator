...
eclipseIRepo="${remoteBase}/eclipse/updates/4.22-I-builds"
eclipseYRepo="${remoteBase}/eclipse/updates/4.22-Y-builds"
eclipsePRepo="${remoteBase}/eclipse/updates/4.22-P-builds"
