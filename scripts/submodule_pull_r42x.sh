...
echo eclipse.platform ; cd eclipse.platform ; git checkout R4_2_maintenance ; git pull ; cd .. 
echo eclipse.platform.common ; cd eclipse.platform.common ; git checkout R4_2_maintenance ; git pull ; cd .. 
echo eclipse.platform.releng ; cd eclipse.platform.releng ; git checkout R4_2_maintenance ; git pull ; cd .. 
echo eclipse.platform.runtime ; cd eclipse.platform.runtime ; git checkout R4_2_maintenance ; git pull ; cd .. 
...
echo eclipse.platform.ui ; cd eclipse.platform.ui ; git checkout R4_2_maintenance ; git pull ; cd .. 
