...
function listDegailedLogs ($machineplatform) {
  ...
  listLogs("perfBaselineresults/$machineplatform");
  if (file_exists("perfBaselineresults/$machineplatform/crashlogs")) {
    echo "<strong>Crash logs captured on $machineplatform</strong>";
    listLogs("perfBaselineresults/$machineplatform/crashlogs");
  }
  if (file_exists("perfBaselineresults/$machineplatform/timeoutScreens")) {
    echo "<strong>Screen captures for tests timing out on $machineplatform</strong>";
    listLogs("perfBaselineresults/$machineplatform/timeoutScreens");
  }
}
...
<li><a href="perfBaselineresults.php#UnitTest">Performance Unit Test Results</a></li>
...
listLogs("perfBaselineresults/consolelogs");
