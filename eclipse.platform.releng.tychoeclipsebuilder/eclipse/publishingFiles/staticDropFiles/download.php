...
if (array_key_exists("SERVER_NAME", $_SERVER)) {
  ...
  if ($servername === "build.eclipse.org") {
    ...
    if ($BUILD_TYPE === "N" || $BUILD_TYPE === "U" || $BUILD_TYPE === "I" || $BUILD_TYPE === "P" || $BUILD_TYPE === "X" || $BUILD_TYPE === "Y" || ($BUILD_TYPE === "M" && ! $isRC)) {
      $BUILD_DIR_NAME = $BUILD_ID;
    } else {
      if ($BUILD_TYPE === "R" || $BUILD_TYPE === "S" || $BUILD_TYPE === "U" || $BUILD_TYPE === "P" || $BUILD_TYPE === "X" || $BUILD_TYPE === "Y" || ($BUILD_TYPE === "M" && $isRC)) {
