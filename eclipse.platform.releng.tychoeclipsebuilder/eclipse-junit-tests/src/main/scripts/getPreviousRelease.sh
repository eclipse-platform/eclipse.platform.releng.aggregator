...
cp /home/files/buildzips/oxygen/R/S-4.28RC2a-202306050440//eclipse-platform-4.28RC2a-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/platformLocation/

cp /home/files/buildzips/oxygen/R/S-4.28RC2a-202306050440//eclipse-SDK-4.28RC2a-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/
