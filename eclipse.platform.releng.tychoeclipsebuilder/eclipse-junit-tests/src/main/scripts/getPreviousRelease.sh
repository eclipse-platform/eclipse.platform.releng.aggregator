...
cp /home/files/buildzips/oxygen/R/S-4.16RC2-202006040540/eclipse-platform-4.16RC2-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/platformLocation/

cp /home/files/buildzips/oxygen/R/S-4.16RC2-202006040540/eclipse-SDK-4.16RC2-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/
