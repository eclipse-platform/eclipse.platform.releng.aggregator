...
cp /home/files/buildzips/oxygen/R/S-4.30RC2-202311231700//eclipse-platform-4.29-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/platformLocation/

cp /home/files/buildzips/oxygen/R/S-4.30RC2-202311231700//eclipse-SDK-4.29-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/
