...
cp /home/files/buildzips/oxygen/R/S-4.23RC2a-202203080310//eclipse-platform-4.23RC2a-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/platformLocation/

cp /home/files/buildzips/oxygen/R/S-4.23RC2a-202203080310//eclipse-SDK-4.23RC2a-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/
