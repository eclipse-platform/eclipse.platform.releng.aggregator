...
cp /home/files/buildzips/oxygen/R/S-4.22RC2-202111241800//eclipse-platform-4.22RC2-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/platformLocation/

cp /home/files/buildzips/oxygen/R/S-4.22RC2-202111241800//eclipse-SDK-4.22RC2-linux-gtk-x86_64.tar.gz ./workarea/${buildId}/eclipse-testing/
