...
fn-gather-sdk () 
{
	...
	cp org.eclipse.sdk.ide-linux.gtk.ia64.tar.gz "$BUILD_DIR"/eclipse-SDK-${BUILD_ID}-linux-gtk-ia64.tar.gz
...
fn-gather-platform () 
{
	...
	cp org.eclipse.rcp.sdk.id-linux.gtk.ppc64le.tar.gz "$BUILD_DIR"/eclipse-platform-${BUILD_ID}-linux-gtk-ppc64le.tar.gz
	...
	cp org.eclipse.rcp.sdk.id-linux.gtk.ia64.tar.gz "$BUILD_DIR"/eclipse-platform-${BUILD_ID}-linux-gtk-ia64.tar.gz
